...
/*
rather than using click event on each dot
use one event listener using event delegation
listen for event on closest common ancestor (.carousel__dots)
this callback triggers whenever user clicks inside dotsContainer
event if they click in between dots
to prevent this -- ensure user has clicked the actual dot by using
closest or matches methods
rest of code inside is same as above
*/
